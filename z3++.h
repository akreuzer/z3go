/*
SWIG Interface Definition for Z3 and modified z3++.h

Based on z3++.h. (Thin C++ layer on top of the Z3 C API.)

Copyright (c) 2017 Alexander Kreuzer <a_kreuzer@posteo.de>
Copyright (c) 2012 Microsoft Corporation

Author of z3++.h:
  Leonardo (leonardo) 2012-03-28

Transformation into SWIG Interface and addition of some extra inline functions
for the GO interface
  Alexander Kreuzer 2017
...
%template(FuncDeclVector) ast_vector_tpl<func_decl>;
    ...
    */
    ...
    public:
        ...
        // for the golang wrapper
        inline std::string String() const { return Z3_model_to_string(ctx(), m_model); }
    };
    ...
    public:
        ...
        // for the golang wrapper
        inline std::string String() const { return Z3_solver_to_string(ctx(), m_solver); }
    };
